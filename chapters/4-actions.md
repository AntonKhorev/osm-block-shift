...
Из прочих редакторов нам по очевидным причинам не подойдут те, которые предназначены для редактирования [POI](https://wiki.openstreetmap.org/wiki/RU:Точки_интереса), например, OsmAnd и maps.me. Раз уж речь зашла о мобильных редакторах, то придётся признать неподходящими их все. Хоть какие-то шансы есть у [Vespucci](https://wiki.openstreetmap.org/wiki/RU:Vespucci), так как он предназначен для редактирования геометрии. Предназначен он для этого, правда, относительно своей платформы, так как из iD на компьютере редактировать было бы легче. На мобильных же устройствах вариантов лучше нет.
